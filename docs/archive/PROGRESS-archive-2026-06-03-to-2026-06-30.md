# PROGRESS.md archive — 2026-06-03 to 2026-06-30

Append-only history artifact (anti-stale.md exemption). Verbatim copy of `PROGRESS.md` in full,
exactly as it stood immediately before the 2026-06-30 reconciliation (`decisions/0022`), at
1281 lines / commit `7b70688`. Do not edit. Live tracker: `../../PROGRESS.md`.

Two items mentioned as still-open partway through this archive were never closed anywhere in
the source and are carried forward live instead of silently archived: `#2 repo-flattening`
(decisions/0011) and the `brain-capture` MCP server prune. See `PROGRESS.md` current section.
