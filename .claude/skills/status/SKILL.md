...
| **Memory** | duplicate/contradictory/stale facts; supersede-orphans | read the vault memory lane (`~/code/schnapp-vault/memory/`) + the freshness gate's supersede check; the consolidation routine's last proposal |
